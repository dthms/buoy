    ...
    return (
        <section className="flex flex-col items-center space-y-10 p-8 bg-gray-100 rounded-lg lg:space-x-16 lg:flex-row lg:p-20 lg:space-y-0">
            ...
            <div className="w-full h-full relative p-12 bg-white rounded-md text-center space-y-12 lg:w-auto">
                <div className="bg-green-50 text-green-700 text-base text-center absolute -right-5 -top-5 font-bold border-4 border-gray-100 rounded-full pt-6 transform rotate-12 w-20 h-20">-50%</div>
                ...
                <div className="space-y-6">
                    ...
                    <a href="https://onkickoff.myshopify.com/cart/37414900334755:1?channel=buy_button" target="_blank" className="w-full py-3 px-4 inline-block text-white text-base font-medium bg-blue-600 rounded-md">Buy Now</a>
                </div>
