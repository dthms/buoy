    ...
    return (
        <section className="mt-12 lg:mt-20 lg:px-20 relative">
            ...
            <div className="w-full lg:w-36 mt-12 lg:mt-16 relative">
                <div className="absolute py-1 -right-3 lg:-right-1 -top-3 rotate-12 transform px-2 bg-green-100 rounded-lg text-xs font-bold text-green-800 border border-green-300 shadow-sm">Save 50%</div>
