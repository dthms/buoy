    ...
    return (
        <section className="mt-12 lg:mt-20 lg:px-20 relative">
            ...
            <div className="mt-12 lg:mt-16 relative">
                ...
                <a href="https://onkickoff.myshopify.com/cart/37414900334755:1?channel=buy_button" target="_blank" className="py-3 px-4 text-center block text-white text-base font-medium bg-blue-600 rounded-md lg:inline-block">{props.buttonOne}</a>
